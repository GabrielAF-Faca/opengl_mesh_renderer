...
objetos = [

    {
        ...
        "obj_buffer" : None,
        "obj_textura" : None,
        "mesh" : 'meshes/pcfoda.obj',
        "textura" : 'textures/pcfoda.png',
    ...
    },
    {
        ...
        "obj_buffer" : None,
        "obj_textura" : None,
        "mesh" : 'meshes/mamadara.obj',
        "textura" : 'textures/madara.png',
    ...
    },
    {
        ...
        "transformacao" : [-200,50,50,0.2,0.2,0.2,0,-45,0]
    },
]
...
def inicializaObjetos():
    ...
    for objeto in objetos:
        ...
        objeto['tex_w'], objeto['tex_h'], objeto['tex_data'] = load_texture(objeto['textura'], objeto['obj_textura'])
...
def inicializaRenderizacao():
    global Window, Shader_programm, WIDTH, HEIGHT, Tempo_entre_frames
    ...
    while not glfw.window_should_close(Window):
        ...
        for objeto in objetos:
            ...
            glTexImage2D(GL_TEXTURE_2D, 0, GL_RGBA, objeto['tex_w'], objeto['tex_h'], 0, GL_RGBA, GL_UNSIGNED_BYTE, objeto['tex_data'])
